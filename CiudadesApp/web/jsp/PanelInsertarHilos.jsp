    ...
    <c:when test = "${(sessionScope.usuario.nombreUsuario != null)}">
        ...
        <section class="box widget find">
            <form action="${pageContext.request.contextPath}/GuardarPregunta" method="post" name="formulario_pregunta">
                <div class="input-container">
                    <label class="titulo"> Añadir pregunta </label> <br><br>
                    <textarea id="pregunta" name="texto" placeholder="Escriba pregunta" cols="26" rows="5" class="letraTextArea" required></textarea><br><br>           
        ...
        <section class="box widget find">
            <form action="${pageContext.request.contextPath}/GuardarEvento" method="post" name="formulario_evento">
                ...
                <label class="titulo"> Añadir evento </label> <br><br>
                ...
                <textarea id="pregunta" name="descripcion" placeholder="Descripción" cols="26" rows="5" class="letraTextArea" required></textarea><br><br> 
